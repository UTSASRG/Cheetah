...
\cheetah{} significantly reduces the performance overhead by leveraging PMU-based sampling mechanisms, such as AMD instruction-based sampling (IBS)~\cite{} and Intel precise event-based sampling (PEBS)~\cite{}, pervasively available in modern CPU architectures. 
