...
\newcommand{\cheetah}{\texttt{Cheetah}}
\newcommand{\Cheetah}{\texttt{Cheetah}}
...
\authorinfo{Tongping Liu~\thanks{Both Tongping Liu and Xu Liu are co-first authors.}}
{Department of Computer Science \\
University of Texas at San Antonio \\
San Antonio, TX 78249 USA \\
{Tongping.Liu}@utsa.edu}

\authorinfo{Xu Liu\hbox to 0in{$\;\;^*$\hss}}
{Department of Computer Science \\
...
\keywords{
Multithreading, False Sharing, Performance Prediction, Address Sampling, Lightweight Profiling}
%}
