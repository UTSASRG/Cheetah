...
Because of using PMU hardware, these tools have typically less than 10\% performance overhead. because of using PMU registers. They may point out a data object suffering with high access latency, but they can not tell whether the high latency comes from false sharing or not. In contrast, \cheetah{} can correctly identify false sharing problems and associate with problematic data objects.
