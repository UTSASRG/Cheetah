...
\cheetah{} proposes to predict the potential performance improvement after fixing an observed false sharing problem, by utilizing the access cycles provided by the PMU hardware. Prior work by utilizes this information to point out variables and instructions suffering with high access latency ~\cite{ibs-sc, ibs-pact}. But we did not find any work that is close to our target. 
